...
function NavigationMenu({
  ...
  return (
    <NavigationMenuPrimitive.Root
      ...
      className={cn(
        // CHANGE: Removed max-w-max, added w-full and position relative
        "group/navigation-menu relative z-10 flex w-full flex-1 items-center justify-center ",
        className
      )}
      {...props}
    >
      {children}
      {/* We move the viewport call to a wrapper below for better centering control */}
...
function NavigationMenuViewport({
  ...
  return (
    // CHANGE: Ensure this container spans the full width of the header to find the true center
